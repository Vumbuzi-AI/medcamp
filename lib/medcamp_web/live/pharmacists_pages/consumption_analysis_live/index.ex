defmodule MedcampWeb.PharmacistsLive.ConsumptionAnalysisIndex do
  @moduledoc """
  Pharmacist view of consumption analysis (pharmaceuticals and non-pharmaceuticals).
  """
  ...
  def render(assigns) do
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
      ...
      <div class="flex flex-wrap items-center gap-3 mb-4">
        ...
        <.filter_drawer
          id="consumption-analysis-filters-pharmacist"
