        ...
        >
          <:empty_state>
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-slate-400">—</td>
              <td class="px-6 py-4 text-sm">
                <span class="inline-flex items-center rounded-md bg-brand-50 px-2.5 py-1 text-xs font-medium text-slate-400">
                  —
                </span>
              </td>
              <td class="px-6 py-4 text-sm">
                <span class="inline-flex items-center rounded-full bg-brand-50 px-2.5 py-1 text-xs font-medium text-slate-400">
                  —
                </span>
              </td>
              <td class="px-6 py-4 text-sm">
              ...
              <td class="px-6 py-4 text-sm">
                <button
                  ...
                  class="inline-flex cursor-not-allowed items-center gap-1.5 text-sm font-medium text-slate-300"
                >
