defmodule MedcampWeb.ReceptionsPageFormLive.HivTestingConsent do
    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-8 print:shadow-none print:border-none print:p-0">
        ...
        <div class="bg-gray-50 rounded-lg p-5 mb-6 text-sm text-gray-700 leading-loose">
          ...
          />,
          hereby give my informed consent to undergo HIV testing.
        </div>
        ...
        <ul class="space-y-3 mb-6 text-sm text-gray-700">
          ...
          <li class="flex items-start gap-2">
            <span class="text-[#373896] font-bold mt-0.5">–</span>
            I understand that the test results will be treated with strict confidentiality.
          </li>
          <li class="flex items-start gap-2">
            <span class="text-[#373896] font-bold mt-0.5">–</span>
            I understand that post-test counseling will be provided after the results.
          </li>
        </ul>

        <p class="text-sm text-gray-700 mb-8">
          I voluntarily agree to be tested for HIV.
        </p>

        <div class="space-y-5 pt-6 border-t border-gray-200">
          <div class="flex flex-col md:flex-row md:items-end gap-4">
            <div class="flex-1">
              <.signature_pad id="hiv-patient-sig" label="Patient's Signature" />
            </div>
            <div class="md:w-44">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              />
              <.signature_pad id="hiv-counselor-sig" label="Counselor's Signature" />
            </div>
            <div class="space-y-2">
              <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide">
                Witness Name
              ...
              />
              <.signature_pad id="hiv-witness-sig" label="Witness Signature" />
            </div>
          </div>
        </div>
      </div>
