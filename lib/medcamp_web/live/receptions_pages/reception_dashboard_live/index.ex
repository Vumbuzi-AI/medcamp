defmodule MedcampWeb.ReceptionDashboardLive.Index do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> assign(:page_title, "Reception Dashboard")
    ...
    <div class="min-h-screen bg-gray-50 -m-4 sm:-m-6 p-4 sm:p-6">
      <div class="w-[95%] mx-auto space-y-6">
        <.dashboard_top_card
          ...
          filter_id="reception-dashboard-filters"
        ...
        >
          ...
          >
            <.chart_panel
              ...
              subtitle="Patients you registered per day."
              config={daily_registrations_chart(@daily_registrations)}
              height="320px"
            />
            <.chart_panel
              title="Age Distribution"
              subtitle="Age segmentation of your registered patients."
  ...
  defp summary_cards(assigns) do
    summary_cards_for(assigns.visible_summary_cards, %{
      total_patients: {assigns.stats.total, "Patients you registered"},
      patient_visits: {length(assigns.visits), "Visits you checked in"},
