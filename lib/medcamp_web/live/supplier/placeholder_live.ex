defmodule MedcampWeb.Supplier.PlaceholderLive do
  @moduledoc false
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      @impl true
      def render(assigns), do: MedcampWeb.Supplier.PlaceholderLive.render_page(assigns)
    end
  end
    ...
    <div class="mx-auto max-w-3xl space-y-4 p-6">
      ...
      <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <p class="mt-2 text-sm text-slate-600">
          Routing and role guards are wired up. The full supplier experience lands in later phases.
        </p>
      </div>
