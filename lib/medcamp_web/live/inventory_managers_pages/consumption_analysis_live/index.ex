defmodule MedcampWeb.InventoryManagerConsumptionAnalysisLive.Index do
  @moduledoc """
  Inventory manager view of consumption analysis (pharmaceuticals and non-pharmaceuticals).
  """
  ...
  # Single unified handler — fired on every form change AND submit
  @impl true
  ...
  def render(assigns) do
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
      ...
      <div class="flex flex-wrap items-center gap-3 mb-4">
        ...
        <.filter_drawer
          id="consumption-analysis-filters-inventory"
  ...
  # Wraps the search term in a highlighted <mark> if found (case-insensitive)
