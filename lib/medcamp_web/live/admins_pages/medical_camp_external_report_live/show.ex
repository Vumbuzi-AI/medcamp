  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-slate-50">
      <div class="mx-auto w-full px-4 py-4 sm:px-6 lg:px-8">
        <div class="medical-camp-report-print-hidden mb-4 flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-4 shadow-card sm:flex-row sm:items-center sm:justify-between">
