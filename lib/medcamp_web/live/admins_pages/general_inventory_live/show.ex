defmodule MedcampWeb.AdminGeneralInventoryLive.Show do
  ...
  def handle_info(
    ...
    {:noreply,
     ...
     |> load_transactions(socket.assigns.general_inventory_item.id)}
  end
  ...
  defp load_transactions(socket, item_id) do
    transactions = Inventories.list_transactions_for_item(item_id)
    ...
    page_transactions =
      Enum.slice(transactions, (page - 1) * socket.assigns.per_page, socket.assigns.per_page)

    socket
    |> assign(:page, page)
    |> assign(:total_count, total_count)
    |> assign(:total_pages, total_pages)
    |> assign(:transactions, page_transactions)
  end
  ...
  def render(assigns) do
    ~H"""
    <div class="space-y-6">
      <.back navigate={~p"/admin/general_inventory"} class="text-[#6667ab] hover:text-[#373896]">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <.header class="text-[#373896] border-b border-gray-100 pb-4 mb-6">
          ...
          <:actions>
            <.link patch={~p"/admin/general_inventory/#{@general_inventory_item}/requisition"}>
            ...
            <.link patch={~p"/admin/general_inventory/#{@general_inventory_item}/show/edit"}>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div class="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-xs text-gray-500 mt-2">
              Reorder at: {Decimal.to_string(@general_inventory_item.reorder_level)}
          ...
          <div class="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">
              KES {Number.Delimit.number_to_delimited(@general_inventory_item.unit_cost,
                precision: 2
              )}
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="space-y-4">
            <div>
              ...
              <p class="text-gray-900 mt-1">{@general_inventory_item.supplier || "Not specified"}</p>
            </div>
            <div>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <.header class="text-[#373896] border-b border-gray-100 pb-4 mb-4">
          Transaction History
          <:actions>
            <.link patch={~p"/admin/general_inventory/#{@general_inventory_item}/transaction/new"}>
          ...
          >
                ...
                <span class="font-semibold text-gray-900">
                  <%= if transaction.transaction_type in ["received", "adjustment"] do %>
                    <span class="text-green-600">
                      +{Decimal.to_string(transaction.quantity)}
                    </span>
                  <% else %>
            ...
            <:action :let={transaction}>
              <.link
                ...
                data-confirm="Are you sure? This will affect stock levels."
      ...
      <.modal
        ...
        show
        on_cancel={JS.patch(~p"/admin/general_inventory/#{@general_inventory_item}")}
      >
        <.live_component
          ...
          patch={~p"/admin/general_inventory/#{@general_inventory_item}"}
        />
      </.modal>
