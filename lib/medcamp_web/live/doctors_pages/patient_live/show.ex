defmodule MedcampWeb.DoctorsPagePatientLive.Show do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <div class="mt-6 rounded-lg border border-slate-100 bg-white p-5 shadow-sm">
        <div class="mb-4 flex items-center justify-between gap-3">
          <div>
            <h3 class="text-lg font-semibold text-brand-primary">Allergy History</h3>
            <p class="text-sm text-slate-500">Known allergies and intolerances for this patient.</p>
          </div>
          <button
            type="button"
        ...
        <%= if @allergy_histories == [] do %>
          <p class="text-sm text-slate-500">No allergy history recorded for this patient.</p>
        <% else %>
              ...
              <div class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                  <div class="flex flex-wrap items-center gap-2">
                    <p class="font-medium text-slate-900">{allergy.substance_name}</p>
                    <span class={[
                  ...
                  <p :if={allergy.notes} class="mt-1 text-sm text-slate-700">{allergy.notes}</p>
                ...
                <div class="flex shrink-0 items-center gap-3">
                  ...
                  <button
                    ...
                    phx-value-id={allergy.id}
                    data-confirm-message="Remove this allergy history entry?"
        ...
        <.simple_form for={@allergy_form} phx-submit="save_allergy" class="mt-4">
          ...
          <:actions>
            <button
              ...
              class="px-4 py-2 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-100"
            >
              Cancel
            </button>
