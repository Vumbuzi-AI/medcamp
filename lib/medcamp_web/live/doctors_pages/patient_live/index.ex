defmodule MedcampWeb.DoctorsPagePatientLive.Index do
  ...
  def handle_event("clear_filters", _params, socket) do
    {:noreply, push_patch(socket, to: ~p"/doctor/patients")}
  end
  ...
  def render(assigns) do
    ...
    <div class="w-[100%]">
      ...
      <.modal
        ...
        id="patient-modal"
        show
        on_cancel={JS.patch(~p"/doctor/patients")}
      >
        <.live_component
          ...
          patient={@patient}
          step="personal"
          patch={~p"/doctor/patients"}
          show_path={fn patient -> ~p"/doctor/patients/#{patient.id}" end}
        />
      </.modal>
    </div>
    """
