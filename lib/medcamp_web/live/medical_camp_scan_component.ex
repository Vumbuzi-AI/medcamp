defmodule MedcampWeb.MedicalCampScanComponent do
  ...
  def render(assigns) do
    ~H"""
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 w-[100%]">
      <.form for={%{}} phx-submit="check" phx-change="check" phx-target={@myself} class="space-y-4">
        <div class="flex items-center mb-4">
          ...
          <h2 class="text-xl font-semibold text-[#373896]">Medical Camp - Patient QR Scanner</h2>
        </div>
  ...
  defp redirect_to_route(role, patient) do
    case role do
      ...
      "doctor" -> "/8018/#{patient.gsrn}/medical-camp/doctor_notes/new"
