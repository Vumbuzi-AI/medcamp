defmodule MedcampWeb.UserRegistrationLive do
    ...
    <div class="w-[90%] mx-auto flex justify-between items-center">
      <div class="w-[48%]">
        <img
          ...
          alt="Medcamp Logo"
          class="w-[100%] object-cover  h-[90vh] mx-auto"
        />
      </div>
      <div class="w-[48%] px-12">
        ...
        <p class="mt-3 text-center">
          Already registered?
          <.link navigate={~p"/users/log_in"} class="font-semibold text-darkblue hover:underline">
            Log in
          </.link>
          to your account now.
        </p>
