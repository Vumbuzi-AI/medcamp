...
module.exports = {
  content: ["./js/**/*.js", "../lib/medcamp_web.ex", "../lib/medcamp_web/**/*.*ex"],
  theme: {
    extend: {
      colors: {
      ...
      boxShadow: {
        card: "0 1px 3px rgba(15, 23, 42, 0.04), 0 8px 24px rgba(15, 23, 42, 0.05)",
        "card-hover": "0 2px 6px rgba(15, 23, 42, 0.06), 0 14px 32px rgba(15, 23, 42, 0.08)",
      },
    },
  },
  plugins: [
