defmodule MedcampWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use MedcampWeb.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user) do
    token = Medcamp.Accounts.generate_user_session_token(user)
